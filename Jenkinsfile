...
pipeline {
    ...
    stages {
        ...
        stage('Run Follow Service (Background)') {
            steps {
                dir('follow-service') {
                    ...
                    REM ✅ Fully detached process (Windows safe)
                    start "follow-service" java -jar target\\follow-service-0.0.1-SNAPSHOT.jar > follow.log 2>&1
                    '''

                    echo "Follow-service started"
                }
            }
        }
